...
import { Upload, FileCode, X, FolderOpen, Loader2 } from 'lucide-react';
      ...
      <div className="w-full max-w-2xl space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-muted-foreground max-w-md mx-auto">
            Upload your project files to analyze for ethical concerns, potential misuse scenarios, and dark patterns.
          </p>
        </div>
